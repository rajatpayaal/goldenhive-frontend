...
import { createBlogAction, getActiveBlogCategoriesAction } from "@/actions/blog.actions";
...
export default function CreateBlogPage() {
  ...
  // Basic content as stringified sections (to match API requirement)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Send content as a simple text section array string
      if (content) {
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-black text-slate-900 md:text-3xl">Write a Blog</h1>
              <p className="mt-1 text-sm font-semibold text-slate-500">Share your travel experiences with the world.</p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold text-slate-900 focus:border-rose-500 focus:bg-white focus:outline-none"
                  placeholder="e.g. travel, mountains, peace"
                />
              </div>
            </div>
          </div>
          ...
          <div className="rounded-[32px] border border-slate-100 bg-white p-6 shadow-sm md:p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <label className="flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50 py-10 transition hover:bg-slate-100">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-sm">
                    <ImageIcon className="h-6 w-6 text-slate-400" />
                  </div>
                  <span className="mt-4 text-sm font-bold text-slate-600">
                    {bannerImageFile ? bannerImageFile.name : "Click to upload banner image"}
                  </span>
